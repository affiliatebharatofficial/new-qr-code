    ...
    default: // 'en'
      return {
        ...
        tips: [
          ...
          'Optical Print Contrast: Maintain strong visual contrast—dark modules on a clean white background provide high optical contrast for reliable camera detection.',
